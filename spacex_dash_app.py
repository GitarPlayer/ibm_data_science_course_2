...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Data filtering based on the site
        # If 'ALL' is selected, we use all values in the 'class' column
        fig = px.pie(spacex_df, values='class', 
                     names='Launch Site', 
                     title='Total Success Launches By Site')
    else:
        # If a specific site is selected, we filter the data for that site
